...
class AdminSupplyOrdersController extends AdminSupplyOrdersControllerCore
{
    ...
    public function setMedia() {
        ...
        Tools::addCSS(_PS_MODULE_DIR_.'supplyordervoucherpdf/css/Ha.css'); 
    }
    ...
    */
    public function renderList()
    {
        ...
        unset($this->fields_list['state'],
              ...
              $this->fields_list['id_print_document']);
        unset($this->_where);
        ...
        $second_list = AdminController::renderList();
    ...
    public function renderDetails()
    {
        if (Tools::isSubmit('id_supply_order') && !Tools::isSubmit('display_product_history')) {
            ...
            $this->fields_list = array(
               ...
               'id_details_receipt_quantity' => array(
                    'title' => $this->l('Quick Detail'),
                    'callback' => 'detailsQuantityByAuditTrailLine',
                    'orderby' => false,
                    'search' => false
                )
               ,
    ...
    */
    ...
    {   
        ...
        $supply_order_voucher = new SupplyOrderVoucher();
        $supply_order_voucher->id_supply_order = $supply_order->id;
        $bFirstTime = true;
        ...
        foreach ($to_update as $id_supply_order_detail => $quantity) {
            ...
            if (Validate::isLoadedObject($supply_order_detail) && Validate::isLoadedObject($supply_order)) {
                if (!Validate::isInt($quantity) || $quantity <= 0 ||  $quantity > ($supply_order_detail->quantity_expected - $supply_order_detail->quantity_received)) {
    ...
    */
    ...
    {    
        ...
        $supply_order_vouchers = $supply_order->getSupplyOrderVoucherCollection((int)$supply_order->id_lang);
    ...
    */
    ...
    {    
        ...
        $supply_order_voucher = new SupplyOrderVoucher((int)$id_supply_order_voucher);
        $supply_order = new SupplyOrder((int)$supply_order_voucher->id_supply_order);
        $supply_order_voucher_products = $supply_order_voucher->getEntriesCollectionVoucher();
